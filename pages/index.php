...
<body>
    ...
    <section class="oferts container" id="lista-1">
        ...
        <div class="oferts-content">
            ...
            <div class="ofert-1">
                ...
                <div class="product-txt">
                    <h3>Sierra electrica</h3>
                    <p>calidad premium</p>
                    <p>Uso 1700w INDUSTRIAL</p>
                    <p class="precio">S/.360</p>
    ...
    <main class="product container" id="lista-2">
        ...
        <div class="product-content">
            ...
            <div class="ofert-1">
                <img src="../img/cemento.png" alt="" />
                <div class="product-txt">
                    <h3>Cemento Andino</h3>
                    <p>calidad premium</p>
            ...
            <div class="ofert-1">
                ...
                <div class="product-txt">
                    <h3>Kit De Martillos</h3>
                    <p>calidad premium</p>
                    <p class="precio">S/80.90</p>
                    <a href="#" class="agregar-carrito btn-3" data-id="9">Agregar</a>
                </div>
            </div>
            <div class="ofert-1">
                <img src="../img/solda.png" alt="" />
                <div class="product-txt">
                    <h3>Soldadura Electrica</h3>
                    <p>calidad premium</p>
                    <p class="precio">S/600</p>
                    <a href="#" class="agregar-carrito btn-3" data-id="10">Agregar</a>
                </div>
            </div>
            <div class="ofert-1">
                <img src="../img/ladri.png" alt="" />
                <div class="product-txt">
                    <h3>Ladrillos</h3>
                    <p>calidad premium</p>
                    <p class="precio">S/12.00</p>
            ...
            <div class="ofert-1">
                <img src="../img/clavos.png" alt="" />
                <div class="product-txt">
                    <h3>Clavos de rollo PHC</h3>
                    <p>calidad premium</p>
                    <p class="precio">S/17.00</p>
